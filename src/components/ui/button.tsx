...
const buttonClasses = cva("relative rounded-[8px] inline-flex items-center", {
  variants: {
    variant: {
      primary: [
      ...
      secondary: [
        ...
        "[&_.highlight]:bg-transparent-white [&_.highlight]:rounded-[8px] [&_.highlight]:px-2 [&_.highlight:last-child]:ml-2 [&_.highlight:last-child]:-mr-2 [&_.highlight:first-child]:-ml-2 [&_.highlight:first-child]:mr-2",
      ],
      teritary: [
        "bg-white border text-grey-dark",
        "[&_.highlight]:bg-transparent-white [&_.highlight]:rounded-[8px] [&_.highlight]:px-2 [&_.highlight:last-child]:ml-2 [&_.highlight:last-child]:-mr-2 [&_.highlight:first-child]:-ml-2 [&_.highlight:first-child]:mr-2",
      ],
    },
    size: {
